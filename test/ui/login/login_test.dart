  ...
  group('LoginContent functionality', () {
    testWidgets('LoginContent sign in', (WidgetTester tester) async {
      ...
      await tester.enterText(
          find.byType(FormBuilderTextField).first, 'abc@gmail.com');
      await tester.enterText(find.byType(FormBuilderTextField).last, '12345');
      await tester.tap(find.byType(ElevatedButton));
      await tester.pumpAndSettle();
      verify(() =>
          loginBloc.add(LoginStartLogin('abc@gmail.com', '12345', false)));
      await expectLater(
    ...
    testWidgets('LoginContent progress indicator', (WidgetTester tester) async {
      ...
      await expectLater(find.byType(MaterialApp),
          matchesGoldenFile('login_page_loading.png'));
    });
  });
}
